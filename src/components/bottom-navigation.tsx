...
export function BottomNavigation({
  ...
  return (
    <nav
      aria-label="底部导航"
      className="absolute bottom-7 left-1/2 z-40 grid h-14 w-[320px] -translate-x-1/2 grid-cols-[1fr_56px_1fr] items-center rounded-[20px] bg-[#1c1f24] px-3 shadow-[0_18px_45px_rgba(0,0,0,0.42),inset_0_1px_0_rgba(255,255,255,0.05)]"
    >
      <a
        href="#/"
